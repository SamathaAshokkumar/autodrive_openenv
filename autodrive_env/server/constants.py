...
SCENARIO_TYPES = {
    "pedestrian_crossing": {"tier": 1, "min_difficulty": 0.0},
    "auto_cut_in": {"tier": 1, "min_difficulty": 0.0},
    "bike_blind_spot": {"tier": 1, "min_difficulty": 0.0},
    "pothole_ahead": {"tier": 2, "min_difficulty": 0.25},
    "speed_breaker": {"tier": 2, "min_difficulty": 0.25},
    "crowded_market": {"tier": 2, "min_difficulty": 0.3},
    ...
    "rain_slippery_road": {"tier": 3, "min_difficulty": 0.5},
    "traffic_light_ambiguity": {"tier": 2, "min_difficulty": 0.3},
    "multi_agent_chaos": {"tier": 3, "min_difficulty": 0.6},
    "adversarial": {"tier": 4, "min_difficulty": 0.7},
}
